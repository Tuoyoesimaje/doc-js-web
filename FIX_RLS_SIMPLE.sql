...
-- =============================================
-- This version uses $$function_body$$ syntax that works in Supabase
-- =============================================
...
DROP POLICY IF EXISTS "Employees create order items" ON order_items;
...
DROP POLICY IF EXISTS "Employees create order events" ON order_events;
...
DROP POLICY IF EXISTS "Employees create garment tags" ON garment_tags;
DROP POLICY IF EXISTS "Employees update garment tags" ON garment_tags;
