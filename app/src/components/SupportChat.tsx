  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-primary-600 to-primary-700 rounded-full shadow-2xl flex items-center justify-center z-40"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-96 h-[500px] bg-white rounded-3xl shadow-2xl z-50 flex flex-col"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-5 rounded-t-3xl flex items-center justify-between">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {messages.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Start a conversation with our support team</p>
                </div>
              ) : (
                messages.map((msg) => (
                  <div
            ...
            <div className="p-4 border-t-2 border-gray-100">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 border-2 border-gray-200 rounded-xl focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition-all"
                />
                <Button
                  onClick={sendMessage}
                  loading={loading}
