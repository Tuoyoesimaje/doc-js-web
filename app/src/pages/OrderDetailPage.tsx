...
export default function OrderDetailPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-primary-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-3">Order Not Found</h2>
  ...
  const statusConfig = {
    received: { color: 'bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600' },
    processing: { color: 'bg-warning-100 text-warning-800 border-warning-200 dark:bg-warning-900/30 dark:text-warning-400 dark:border-warning-800' },
    ready: { color: 'bg-primary-100 text-primary-800 border-primary-200 dark:bg-primary-900/30 dark:text-primary-400 dark:border-primary-800' },
    delivered: { color: 'bg-accent-100 text-accent-800 border-accent-200 dark:bg-accent-900/30 dark:text-accent-400 dark:border-accent-800' },
  }
      ...
      <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-b-2 border-gray-100 dark:border-gray-700 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <button
            ...
            className="flex items-center gap-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-semibold mb-4 transition-colors"
          >
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-1">Order Details</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400">Order #{order.id.slice(0, 8).toUpperCase()}</p>
            </div>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="space-y-8">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-3xl border-2 border-gray-100 dark:border-gray-700 p-8 shadow-lg"
          >
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-6">Order Status</h2>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-3xl border-2 border-gray-100 dark:border-gray-700 p-8 shadow-lg"
          >
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-6">Items</h2>
            <div className="space-y-4">
              {order.items?.map((item) => (
                <div key={item.id} className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-2xl">
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-1">{item.description}</h4>
            ...
            {order.logistics_option !== 'none' && (
              <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-2xl border-2 border-blue-200 dark:border-blue-800">
            ...
            <div className="border-t-2 border-gray-200 dark:border-gray-700 mt-6 pt-6 flex justify-between items-center">
              <span className="text-2xl font-display font-bold text-gray-900 dark:text-white">Total</span>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white">Delivery Address</h2>
            </div>
            <div className="text-gray-700 dark:text-gray-300 leading-relaxed">
              <p className="font-semibold text-gray-900 dark:text-white mb-1">{order.address?.label}</p>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white">Garment Tags</h2>
                </div>
