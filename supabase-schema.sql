...
CREATE TABLE orders (
  ...
  payment_method TEXT CHECK (payment_method IN ('prepay', 'postpay')) DEFAULT 'prepay',
  pickup_fee_paid BOOLEAN DEFAULT FALSE,
  final_payment_pending BOOLEAN DEFAULT FALSE,
